...
<html>
    ...
    <body>
                        ...
                        <nav>
                            <div>
                                <ul>
                                    ...
                                    <li><a href="donner.php"><i class="fa fa-heartbeat" aria-hidden="true"></i> Donner du sang</a></li>
                                    <li><a href="coded-fr.php" id="index"><i class="fa fa-users" aria-hidden="true"></i> Personnel</a></li>
                                </ul>
                            </div>
                        </nav>
        ...
        <section id="question">
            <div id="quest">
                <h2><i>Cette espace est reserve pour les personnel!</i></h2>
        ...
        <div id="con">
            ...
            <div id="member">
                <div id="mem">
                    <div id="Member-area">
                        <form action="includes/coded-fr.php" method="POST">
                            ...
                            <input type="submit" name="submit" value="Soummetre" id="button_1"> 
                            <?php

                                    $fullUrl = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";

                                    if(strpos($fullUrl, "signup=empty") == true) {
                                        echo"<p class='error'>vous naviez pas remplis tout le formulaire!</p>";
                                        exit();
                                    }
                                    elseif(strpos($fullUrl, "signup=wrongusername") == true) {
                                        echo"<p class='error'>Username est incorrecte!</p>";
                                        exit();
                                    }
                                    elseif(strpos($fullUrl, "signup=wrongpwd") == true) {
                                        echo"<p class='error'>mot-de-passe est incorrect!</p>";
                                        exit();
                                    }
                            ?>  
                        </form>
